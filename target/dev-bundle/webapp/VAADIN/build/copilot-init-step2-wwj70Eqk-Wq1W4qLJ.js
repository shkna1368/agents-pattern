import { $, F as Fi, g as fl, b as b$1, K as Ki, l as ls, x as xs, j as be$1, e as er, S as Sl, m as ie, n as cs, L as Ll, A as Al, Z as Zi, w as wr, J as Je, B as Bl, o as wl, E, p as Kl, s as Hl, U as Ul, t as cl, u as sl, D as Dl } from "./indexhtml-CvdgsICL.js";
import { g as g$1, h } from "./state-DIGAkjaT-BGRZ1E2Z.js";
import { p as p$1, b as b$2 } from "./overlay-monkeypatch-BJzx8nYb-CxsETFha.js";
import { r as r$1 } from "./icons-BFatMQTq-O7AzOy4n.js";
import { K as K$1 } from "./react-utils-DFD62MFY-DV-Nu30T.js";
import { showNotification as N$1, dismissNotification as m$1 } from "./copilot-notification-COJP6ks5-DFPfAAG2.js";
/**
 * @license
...
let b = class extends xs {
  constructor() {
    super(...arguments), this.position = "right", this.opened = false, this.keepOpen = false, this.resizing = false, this.closingForcefully = false, this.draggingSectionPanel = null, this.activationAnimationTransitionEndListener = () => {
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        er.panels.filter((i) => !i.floating && i.panel === this.position).forEach((i) => {
          er.updatePanel(i.tag, n);
        });
      });
      ...
      if (!Sl(this.getBoundingClientRect(), t, o)) {
      ...
      this.cleanUpDragging(), er.updateOrders(e), document.removeEventListener("mouseup", this.sectionPanelDraggingFinished), document.removeEventListener("mousemove", this.sectionPanelDragging);
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      (t) => {
        t === Ll.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
      () => er.getAttentionRequiredPanelConfiguration(),
      () => {
        const t = er.getAttentionRequiredPanelConfiguration();
        t && !t.floating && this.toggleAttribute(Al, t.panel === this.position);
      }
    ), this.reaction(
      () => b$1.active,
      () => {
        if (!b$1.active || !Zi.isActivationAnimation() || b$1.activatedFrom === "restore" || b$1.activatedFrom === "test")
          return;
        const t = er.getAttentionRequiredPanelConfiguration();
  ...
  updated(e) {
    super.updated(e), e.has("opened") && this.opened && this.hasAttribute(Al) && (this.removeAttribute(Al), er.clearAttention()), this.updateScrollable();
  }
...
let T = class extends xs {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = false, this.mouseDownListener = (e) => {
      ...
      return e ? e.panel && !e.floating ? ($.emit("open-attention-required-drawer", null), true) : (er.clearAttention(), true) : false;
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      () => er.attentionRequiredPanelTag,
      () => {
        this.toggleAttribute(Al, er.attentionRequiredPanelTag !== null);
      }
    ), this.reaction(
      () => b$1.active,
      () => {
        ...
        children: [
          {
            component: p("vaadin-menu-bar-item", {
              ...
              hint: Zi.isActivationShortcut() ? Bl.toggleCopilot : void 0
            }),
            action: "copilot"
          },
          {
  ...
  handleMenuItemClick(e) {
    switch (e.action) {
      ...
      case "redo":
        ...
        break;
      case "feedback":
        er.updatePanel("copilot-feedback-panel", {
          floating: true
        });
        break;
      case "welcome":
        ...
        break;
      case "shortcuts":
        er.updatePanel("copilot-shortcuts-panel", {
          floating: true
        });
        break;
    }
...
let w = class extends xs {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      this.hasAttribute(_) && (e.stopPropagation(), e.preventDefault(), m.anchorLeftTop(this), this.floatingResizingStarted = true, this.toggleAttribute("resizing", true), wl(() => {
      ...
      if (!this.floatingResizingStarted || !this.panelInfo?.floating)
        return;
      e.stopPropagation(), e.preventDefault(), this.floatingResizingStarted = false, wl(() => {
      ...
      er.updatePanel(this.panelInfo.tag, {
        width: t,
        height: o - (h2 + P),
        floatingPosition: {
      ...
      this.style.setProperty("--section-height", `${o}px`), er.updatePanel(this.panelInfo.tag, {
        height: o
      });
      ...
      this.hasAttribute(Al) && (this.removeAttribute(Al), er.clearAttention());
    }, this.contentAreaMouseDownListener = () => {
      er.addFocusedFloatingPanel(this.panelInfo);
      ...
      e.button === 0 && (er.addFocusedFloatingPanel(this.panelInfo), !this.hasAttribute(g) && (e.target instanceof HTMLButtonElement && e.target.getAttribute("part") === "title-button" ? this.startDraggingDebounce(e) : this.startDragging(e)));
    ...
    }, this.startDraggingDebounce = fl(this.startDragging, 200), this.draggingEventListener = (e) => {
      const t = m.dragging(this, e);
      ...
      const e = er.getPanelByTag(this.panelTag);
      ...
      if (!this.panelInfo)
        return E;
      let e;
      return this.panelInfo.panel === void 0 ? e = "Close the popup" : e = this.panelInfo.floating ? `Dock ${this.panelInfo.header} to ${this.panelInfo.panel}` : `Open ${this.panelInfo.header} as a popup`, wr`
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), Kl(this), this.panelInfo?.floating)
          er.updatePanel(this.panelInfo?.tag, { floating: false });
        else {
          let t;
          ...
          o === void 0 && this.panelInfo.expanded && (o = Number.parseInt(window.getComputedStyle(this).height, 10)), this.parentElement.forceClose(), er.updatePanel(this.panelInfo?.tag, {
            floating: true,
      ...
      this.panelInfo && (e.stopPropagation(), m.anchorLeftTop(this), er.updatePanel(this.panelInfo.tag, {
  ...
  connectedCallback() {
    super.connectedCallback(), this.setAttribute("role", "region"), this.reaction(
      ...
      () => {
        const e = er.getAttentionRequiredPanelConfiguration();
        this.toggleAttribute(Al, e?.tag === this.panelTag && e?.floating);
      }
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            b$1.operationInProgress === Ll.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
      () => er.floatingPanelsZIndexOrder,
      () => {
        this.style.setProperty("--z-index-focus", `${er.getFloatingPanelZIndex(this.panelTag)}`);
      },
      { fireImmediately: true }
  ...
  willUpdate(e) {
    super.willUpdate(e), e.has("panelTag") && (this.panelInfo = er.getPanelByTag(this.panelTag), this.setAttribute("aria-labelledby", this.panelInfo.tag.concat("-title"))), this.toggleAttribute("floating", this.panelInfo?.floating);
  }
  updated(e) {
    super.updated(e), this.setCssSizePositionProperties();
  }
  firstUpdated(e) {
    super.firstUpdated(e), document.addEventListener("mouseup", this.documentMouseUpEventListener), this.headerDraggableArea.addEventListener("mousedown", this.panelHeaderMouseDownEventListener), this.toggleAttribute("expanded", this.panelInfo?.expanded), Hl(this), this.setCssSizePositionProperties(), this.contentArea.addEventListener("mousedown", this.contentAreaMouseDownListener), this.drawerResizeElement.addEventListener("mousedown", this.resizeInDrawerMouseDownListener), b$2(this.shadowRoot);
  }
  render() {
    return this.panelInfo ? wr`
      <div part="container">
        <div part="header" class="drag-handle">
          ${this.panelInfo.expandable !== false ? wr` <button
                part="toggle-button"
  ...
  renderHelpButton() {
    return this.panelInfo?.helpUrl ? wr` <button
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      const o = er.panels.filter((n) => n.panel === t).map((n) => n.panelOrder).sort((n, i) => i - n)[0];
      Kl(this), er.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: o + 1 });
    }
...
w = k([
  ls("copilot-section-panel-wrapper")
], w);
$.on("undoRedo", (e) => {
...
let Y = class extends xs {
  ...
  render() {
    return wr`<div class="notification-tray">
      ...
      <div
        ...
        <div class="message-content">
          ...
          <div class="message-details" ?hidden="${!e.details && !e.link}">
            ${Dl(e.details)}
            ${e.link ? wr`<a class="ahreflike" href="${e.link}" target="_blank">Learn more</a>` : ""}
          </div>
          ${e.dismissId ? wr`<div
...
Y = ke([
  ls("copilot-notifications-container")
], Y);
function Ie(e) {
...
$.on("copilot-plugin-state", (e) => {
  b$1.setIdePluginState(e.detail), e.detail.active && Ki("plugin-active", `${e.detail.version}-${e.detail.ide}`), e.preventDefault();
});
